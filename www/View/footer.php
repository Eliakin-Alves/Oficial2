...
<footer class="rodape footer-classic navbar navbar-expand-lg navbar-light bg-light bg-image">
        ...
        <div class="social-container">
          <div class="col"><a class="social-inner" href="#"><span><i class="fab fa-facebook-square fa-2x"></i></span></a></div>
          
          <div class="col"><a class="social-inner bg-yellow" href="#"><span><i class="fab fa-instagram fa-2x"></i></span></a></div>
          <div class="col"><a class="social-inner bg-yellow" href="#"><span><i class="fab fa-twitter-square fa-2x"></i></span></a></div>
          <div class="col"><a class="social-inner bg-yellow" href="#"><span><i class="fab fa-google-plus-square fa-2x"></i></span></a></div>

...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
  <div class="carousel-inner foto1">
    <div class="carousel-item active">
      <img src="img/carrocel.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/carrocel1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/carrocel2.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
    ...
    <div class="col-md-4 top">
        <div class="card rounded ">
            <div class="card-image">
                ...
                <img class="img-fluid" src="<?php echo $url;['imagem'] ?>/View/img/produtos/<?php echo $produto['imagem'] ?><?php echo $produto['imagem'] ?>" alt="Alternate Text" />
            </div>
